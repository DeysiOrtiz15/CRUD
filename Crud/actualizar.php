...
try {
    ...
    $query = "SELECT id, nombres, apellidos, direccion,telefono,fechanac FROM empleados WHERE id = ? LIMIT 0,1";
...
if($_POST){
    ...
    try{
        ...
        $query = "UPDATE empleados
                    SET nombres=:nombres, apellidos=:apellidos, direccion=:direccion, telefono=:telefono, fechanac=:fechanac
                    WHERE id = :id";
    ...
    <table class='table table-hover table-responsive table-bordered'>
        ...
        <tr>
            ...
            <td>
                ...
                <a href='Emple.php' class='btn btn-danger'>Back to read products</a>
            </td>
        </tr>
    </table>
</form>
