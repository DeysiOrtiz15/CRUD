...
// select all data
$query = "SELECT id, nombres, apellidos,direccion,fechanac,telefono FROM empleados ORDER BY id DESC";
...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    echo "<tr>
        ...
        <td>";
            ...
            echo "<a href='actualizar.php?id={$id}' class='btn btn-primary m-r-1em'>Edit</a>";
